                ...
                <div className="space-y-4 max-h-[50vh] overflow-y-auto pb-4 pr-1">
                  {roster.length === 0 && (
                    <div className="text-center py-10 border-2 border-dashed border-gray-200 rounded-2xl">
                      ...
                      <p className="text-gray-500 font-bold">Your schedule is empty.</p>
                      <p className="text-xs text-gray-400">Pick specific dates, or use Quick Fill.</p>
                    </div>
                  )}
              ...
              <div className="space-y-4 text-sm text-gray-800">
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="font-black uppercase text-qsDark">{tab} {tier}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-xs font-bold text-gray-500 uppercase tracking-wider">Total Deliveries</span>
                    <span className="font-bold text-qsOrange">{maxDays} Days Scheduled</span>
                  </div>
                </div>
